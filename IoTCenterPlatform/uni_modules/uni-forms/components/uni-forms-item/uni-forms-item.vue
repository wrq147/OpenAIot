	...
	<view class="uni-forms-item"
		...
		<slot name="label">
			<view class="uni-forms-item__label" :class="{'no-label':!label && !required}"
				:style="{width:localLabelWidth,justifyContent: localLabelAlign,'font-size':labelFont,color:labelColor,'line-height':labelFont,'padding':isDis?'0 0 15rpx':'0 0 20rpx'}" v-if="showLabel">
