<template>
	...
	<cell :keep-scroll-position="keepScrollPosition">
		<!-- #endif -->
		<view :class="{ 'uni-list-item--disabled': disabled }" :style="{'background-color':customStyle.backgroundColor,'color':customStyle.color?customStyle.color:''}"
...
<style lang="scss">
	...
	$uni-border-color:rgba(255, 255, 255, 0.20);
	$uni-bg-color-hover:#1c2232;
