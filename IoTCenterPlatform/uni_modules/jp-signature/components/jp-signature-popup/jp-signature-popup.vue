				...
				<view class="popup-content">
					<view class="popup">
						...
						<view class="wgSignature">
							<view key="888"
								style="width: 100% ;height: 24vh;background-color: #fff;border-radius: 10rpx;margin-top: 10rpx;">
								<jp-signature :beforeDelay="200" disableScroll ref="signatureRef"
									:openSmooth="openSmooth" :bounding-box="true" :penSize="3"></jp-signature>
							</view>
							<!-- <view class="appBut" >
						...
						<view class="btn_con" style="margin-top: 40rpx;">
							<button class="jump_button" @click.stop="deleteImg">
								Clean up
							</button>
