<template>
	<view>
		<top :title="topTitle" leftText="Back" leftWidth="157rpx" leftIcon="icon-fanhui" :rightText="allSelect"
			rightWidth="157rpx" :isleftBack="true" backgroundColor="#161A26" @clickRight="handleCheckAllChange"></top>
		<search-compt :isOnlySearch="true" pal="Please enter the customer name" @searching="searchUser"></search-compt>
				...
				<view class="alselect_con">
					<scroll-view class="alselect_ul" scroll-x="true">
						...
						<view class="select_li" v-for="item in select">
							<image class="avatar_image" :src="item.avatar+'?wh=500x500'" mode=""
