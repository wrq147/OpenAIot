		...
		<view class="content-box">
			<scroll-view scroll-y="true">
				<view v-for="(item,index) in list" :key="index" class="item-box" @click="provinceClick(item,index)">
					<image v-if="item.checkStatus==undefined||item.checkStatus==0||item.checkStatus==null" class="image-ico" src="@/static/address/none-selected.png" @click="provinceIconClick(item,index)"></image>
					<image v-if="item.checkStatus&&item.checkStatus==1" class="image-ico" src="@/static/address/half-selected.png" @click="provinceIconClick(item,index)"></image>
					<image v-if="item.checkStatus&&item.checkStatus==2" class="image-ico" src="@/static/address/all-selected.png" @click="provinceIconClick(item,index)"></image>
			...
			<scroll-view scroll-y="true" v-if="list[selectProvinceIndex] && list[selectProvinceIndex].children">
				<view v-for="(item,index) in list[selectProvinceIndex].children" :key="index" class="item-box left-gap"
					...
					<image v-if="item.checkStatus==undefined||item.checkStatus==0||item.checkStatus==null" class="image-ico" src="@/static/address/none-selected.png" @click="cityIconClick(item,index)"></image>
					<image v-if="item.checkStatus&&item.checkStatus==1" class="image-ico" src="@/static/address/half-selected.png" @click="cityIconClick(item,index)"></image>
					<image v-if="item.checkStatus&&item.checkStatus==2" class="image-ico" src="@/static/address/all-selected.png" @click="cityIconClick(item,index)"></image>
			...
			<scroll-view scroll-y="true"
				...
				<view v-for="(item,index) in list[selectProvinceIndex].children[selectCityIndex].children" :key="index"
					...
					<image v-if="item.checkStatus==undefined||item.checkStatus==0||item.checkStatus==null" class="image-ico" src="@/static/address/none-selected.png" @click="regionIconClick(item,index)"></image>
					<image v-if="item.checkStatus&&item.checkStatus==1" class="image-ico" src="@/static/address/half-selected.png" @click="regionIconClick(item,index)"></image>
					<image v-if="item.checkStatus&&item.checkStatus==2" class="image-ico" src="@/static/address/all-selected.png" @click="regionIconClick(item,index)"></image>
					</image>
					<text>{{item.Name}}</text>
				</view>
			</scroll-view>
