	...
	<view style="width: 100%;">
		<view class="int_date">
			<view class="date_con long_date" style="color: #fff;">
				<uni-datetime-picker v-model="_value" :disabled="disabled" :type="type" :isDark="true" :isCustom="true"
					:start-placeholder="placeholder[0]" :return-type="format" :end-placeholder="placeholder[1]" />
			</view>
		</view>
