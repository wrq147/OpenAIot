<template>
	<view style="width:100%">
		...
		<uni-popup :ref="'devSelect'+keyId" :mask-click="false" background-color="#161A26" :safe-area="true"
			mask-background-color="rgba(0, 0, 0, 0.5)" type="top" :zIndex="999">
			<view style="width: 100%;height: 100vh;position: relative;">
				<deviceSelect :ref="'devSel'+keyId" topTitle="Select department" :isMulSelect="limit>1"
