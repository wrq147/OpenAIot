	...
	<view @click="parIsFocus=false" style="min-height: 100vh;">
		...
		<uni-forms ref="classForm" :modelValue="classForm" :rules="rules" labelWidth='80' label-position="top">
			<view class="form_con page_form_con">
				<uni-forms-item label="Category parent" name="parentId" id="parentId_form" labelFont="32rpx"
					...
					<view id="parentId" class="form_li" @click.stop="choiceParentClass">
						<!-- <uni-easyinput placeholderStyle="color:rgba(255, 255, 255, 0.2);font-size:32rpx"
							...
							placeholder="Please select a parent category" contentFontSize="32rpx"
							primaryColor="rgba(255, 255, 255, 0.5)" :clearable="false" /> -->
						<view class="form_input"
							:class="{'placeholder_input':!classForm.parentName||classForm.parentName==''}">
							{{classForm.parentName?classForm.parentName:'Please select a parent category'}}
						</view>
				...
				<uni-forms-item label="Category name" required name="name" id="name_form" labelFont="32rpx"
					contentFont="32rpx" :requireOpacity="0.5">
				...
				<uni-forms-item label="sort" required name="sort" id="sort_form" labelFont="32rpx" contentFont="32rpx"
					:requireOpacity="0.5">
						...
						<view style="width: 100%;">
							<view class="li_flex">
								<uni-easyinput placeholderStyle="color:rgba(255, 255, 255, 0.2);font-size:32rpx"
									...
									placeholder="Please enter sorting values" contentFontSize="32rpx"
									primaryColor="rgba(255, 255, 255, 0.5)" @input="filterValue($event,0)" />
								<view class="num_cli">
							...
							<view class="tips_text">
								The smaller the sorting value, the higher the ranking
							</view>
						</view>
					</view>
				</uni-forms-item>
			...
			return {
				...
				rules: {
					...
					sort: {
						rules: [{
							required: true,
							errorMessage: "Please enter sorting values"
						}]
					},
					//自定义校验器
					photoUrl: {
			...
			deleteClass() {
				try {
					this.$refs.promptMsg.noticeOpen(
						'Are you sure to delete category ' + this.classForm.name +
