<template>
	<view class="contacts">
		<top leftIcon="icon-fanhui" :isleftBack="true" leftText="Back" backgroundColor="#161A26"  title="Contacts" rightIcon="icon-a-tianjiabantouming"
			class="CRM-header">
			...
			<search-compt ref="selectCompt" @openSelect="openSelect" @searching="searching" pal="Please enter the name of the contact person"></search-compt>
			...
			<view class="contacts-list" v-for="(item,index) in customerData" :key="index" @click="handDetails(item)">
				<view class="contacts-list-item">
					<view class="contacts-list-item-atve iconfont t-icon-morentouxiang">
					...
					<view class="contacts-list-item-content">
						...
						<!-- <custom-icons class="customIcons-dianhua" iconsName="icon-dianhua" iconsSize="55rpx"></custom-icons> -->
						<view class="iconfont t-icon-dianhua" @click.stop="dialogConfirm(item.Mobile)"></view>
				</view>
			</view>
