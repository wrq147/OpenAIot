<template>
	<view class="CompanyInfo">
		<top  leftIcon="icon-fanhui" :isleftBack="true" leftText="Back" backgroundColor="#161A26" title="Company information" class="CRM-header"></top>
		...
		<view class="CompanyInfo-Information">
			...
			<uni-data-picker  v-model="formData.industry" style="color:rgba(255, 255, 255, .2)"  placeholder="Please select Industry type" popup-title="Please select" :isDark="true" :clear-icon="false"  :localdata="ObtainInData" @change="onchange" @nodeclick="onnodeclick"></uni-data-picker>
				</uni-forms-item>
					...
					:isDark="true"
					  :clear="false"
					      ...
					      :localdata="comSizeItems"
						    type="line"
							placeholder="Please select Expected usage scale"
				...
				<uni-forms-item label=" Creation date" name="createTime"  class="addPool-form-item">
					<input disabled type="text" v-model="formData.createTime" class="addPool-easyinput" style="background: #1C2232!important" placeholder="Creation date">
				</uni-forms-item>
				<uni-forms-item label="Update date" name="updateTime"  class="addPool-form-item">
					<input disabled type="text" v-model="formData.updateTime" class="addPool-easyinput" style="background: #1C2232!important" placeholder="Update date">
				</uni-forms-item>
				
				
				<uni-forms-item label="Others" name="size"  class="addPool-form-item">
					<!-- <view class="Others"> 
						<view>
							PSI set
						</view>
		...
		methods:{
			...
			handSave(){
				...
				this.$refs.form.validate().then(data => {
				   ...
				   console.log(this.formData,data,'企业编辑')
