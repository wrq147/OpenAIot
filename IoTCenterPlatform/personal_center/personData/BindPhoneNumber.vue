<template>
	<view class="BindPhoneNumber">
		...
		<uni-forms ref="loginForm" :modelValue="loginForm" :rules="rules" labelWidth='80' label-position="top" style="width: 92%;margin:50rpx 4%;">
			<uni-forms-item required label="  Phone" name="orgName" class="addPool-form-item">
				<input  v-model="loginForm.phone" type="text" class="addPool-easyinput" placeholder="Please enter your phone" placeholder-style="color:rgba(255, 255, 255, .2);">
			</uni-forms-item>
			
			<uni-forms-item required label="  Verification code" name="imgCode" class="addPool-form-item" v-if="hideCode">
				<view style="display: flex;">
					<view class="BindPhoneNumber-text" style="width: 450rpx;">
						<input @input="handInput" style="border: none;" class="BindPhoneNumber-text-input"  v-model="loginForm.imgCode" type="text"   placeholder="Please enter the code" placeholder-style="color:rgba(255, 255, 255, .2);">
					</view>
		...
		<button class="Confirm" :disabled="isSubmit" @click="handSubmit" :class="[loginForm.phone&&loginForm.code?'ConfirmActive':'ConfirmOn']">Confirm</button>
