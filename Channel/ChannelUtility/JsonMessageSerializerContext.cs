...
namespace ChannelUtility
{
    ...
    [JsonSerializable(typeof(NodeOnlineMessageReply))]
    ...
    [JsonSerializable(typeof(MediaPresetMessage))]
    ...
    [JsonSerializable(typeof(MediaRecordStartMessage))]
    [JsonSerializable(typeof(MediaRecordStartMessageReply))]
    [JsonSerializable(typeof(MediaRecordStopMessage))]
    [JsonSerializable(typeof(MediaRecordStopMessageReply))]
    [JsonSerializable(typeof(MediaRecordFileMessage))]
