...
namespace FixVideoChannel
{
    public class AIDetectorTask
    {
        ...
        // AI检测
        public void Detect(string videoId, string videoKey, int width, int height, float motionRatio, IVideoDeviceEventListener listener, ref byte[] data, ref bool isPress)
        {
            if (listener == null)
            {
                return;
