...
namespace GB28181.Servers
{
    public class SIPServiceDirector : ISIPServiceDirector
    {
        ...
        {
            logger.LogDebug("Make video request started.");
        ...
        {
            logger.LogDebug("BackVideoReq started.");
            var target = GetTargetMonitorService(gbid);
            if (target == null)
            {
                return null;
        ...
        public bool Stop(string gbid, string sessionid)
        {
            ...
            logger.LogDebug("Video request stopped.");
            return true;
        }
        #endregion
        ...
        {
            logger.LogDebug("Device Catalog Query started.");
        ...
        {
            logger.LogDebug("Device Catalog Subscribe started.");
        ...
        {
            logger.LogDebug("Video Download Request started.");
            var target = GetTargetMonitorService(gbid);
            if (target == null)
            {
                return null;
        ...
        public bool BackVideoStopPlayingControlReq(string gbid, string sessionid)
        {
            ...
            logger.LogDebug("BackVideoStopPlayingControlReq stopped.");
            return true;
        }
        /// <summary>
        /// BackVideoSpeed
        ...
        public bool BackVideoPlaySpeedControlReq(string gbid, string sessionid, float scale)
        {
            ...
            logger.LogDebug("BackVideoPlaySpeedControlReq stopped.");
            return true;
        }
        /// <summary>
        /// BackVideoPause
        ...
        public bool BackVideoPauseControlReq(string gbid, string sessionid)
        {
            ...
            logger.LogDebug("BackVideoPauseControlReq stopped.");
            return true;
        }
        /// <summary>
        /// BackVideoContinue
        ...
        public bool BackVideoContinuePlayingControlReq(string gbid, string sessionid)
        {
            ...
            logger.LogDebug("BackVideoContinuePlayingControlReq stopped.");
            return true;
        }
        /// <summary>
        /// BackVideoPosition
        ...
        public bool BackVideoPlayPositionControlReq(string gbid, string sessionid, long time)
        {
            ...
            logger.LogDebug("BackVideoPlayPositionControlReq stopped.");
            return true;
        }
        #endregion
    }
