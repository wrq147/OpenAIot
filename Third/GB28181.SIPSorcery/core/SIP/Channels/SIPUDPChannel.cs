    ...
    public class SIPUDPChannel : SIPChannel
    {
        ...
        private void Initialise()
        {
            try
            {
                ...
                //logger.LogDebug("SIPUDPChannel.Initialise: IPEndPoint=" + ipedp.ToString());
        ...
        private void Listen()
        {
            try
            {
                ...
                logger.LogDebug("SIPUDPChannel socket on 0.0.0.0:" + m_localSIPEndPoint.GetIPEndPoint().Port + " listening started.");

                while (!Closed)
                {
                    IPEndPoint inEndPoint = new IPEndPoint(IPAddress.Any, 0);
                    //logger.LogDebug("SIPUDPChannel socket start.Receive.");
                    try
                    {
                    ...
                    catch (SocketException sockex)
                    {
                        ...
                        logger.LogError("SocketException listening on SIPUDPChannel. " + sockex.Message);
                        continue;
                    }
                    ...
                    //logger.LogDebug("SIPUDPChannel socket end.Receive.");
                    ...
                    //logger.LogDebug("SIPUDPChannel socket message handled.");
                }
