...
namespace GB28181
{
    public class SIPTLSChannel : SIPChannel
    {
        ...
        private new ILogger logger = AppState.GetLogger("siptls-channel");
        ...
        private void DisplayCertificateChain(X509Certificate2 certificate)
        {
            ...
            foreach (X509ChainElement element in ch.ChainElements)
            {
                ...
                Console.WriteLine("Element LogError status length: {0}", element.ChainElementStatus.Length);
        ...
        private bool ValidateServerCertificate(
            ...
            X509Chain chain,
            SslPolicyErrors sslPolicyLogErrors)
        {
            if (sslPolicyLogErrors == SslPolicyErrors.None)
            {
                return true;
            }
            else
            {
                logger.LogWarning(string.Format("Certificate LogError: {0}", sslPolicyLogErrors));
                return true;
            }
        }
