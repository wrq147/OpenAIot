...
namespace GB28181.Net
{
    public class RTSPClient
    {
        ...
        private static ILogger logger = AssemblyStreamState.logger;
                        ...
                        if (rtpPacket != null)
                        {
                            ...
                            else
                            {
                                ...
                                if (frame.IsComplete)
                                {
                                    ...
                                    //System.Diagnostics.LogDebug.WriteLine("Frame ready " + frame.Timestamp + ", sequence numbers " + frame.StartSequenceNumber + " to " + frame.EndSequenceNumber + ",  payload length " + imageBytes.Length + ".");
                                    ...
                                    if (OnFrameReady != null)
                                    {
                                        try
                                        {
                                            ...
                                            //else
                                            //{
                                            //System.Diagnostics.LogDebug.WriteLine("RTP frame ready for timestamp " + frame.Timestamp + ".");
