...
namespace GB28181.Net
{
    ...
    public class RTPSink
    {
        ...
        private static ILogger logger = AppState.GetLogger("rtp");
        ...
        public RTPSink(IPAddress localAddress, ArrayList inUsePorts)
        {
            ...
            try
            {
                ...
                logger.LogDebug("Setting RTP packet ToS to " + m_typeOfService + ".");
            }
            catch (Exception excp)
            {
                logger.LogWarning("Exception setting IP type of service for RTP packet to " + typeOfService + ". " + excp.Message);
            }
