    ...
    public class SIPEventDialog
    {
        ...
        public SIPEventDialog(string id, string state, SIPDialogue sipDialogue)
        {
            ...
            if (sipDialogue != null)
            {
                ...
                Direction = (sipDialogue.Direction == SIPCallDirection.In)
                    ? SIPEventDialogDirectionEnum.recipient
                    : SIPEventDialogDirectionEnum.initiator;
                Duration = Convert.ToInt32((DateTimeOffset.UtcNow - sipDialogue.Inserted).TotalSeconds %
                                           Int32.MaxValue);
                ...
                LocalParticipant = new SIPEventDialogParticipant(sipDialogue.LocalUserField.Name,
                    sipDialogue.LocalUserField.URI, null, sipDialogue.CSeq);
                ...
                RemoteParticipant = new SIPEventDialogParticipant(sipDialogue.RemoteUserField.Name,
                    sipDialogue.RemoteUserField.URI, sipDialogue.RemoteTarget, sipDialogue.CSeq);
