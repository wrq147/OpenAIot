...
namespace LibGB28181SipServer.Structs
{
    [Serializable]
    ...
    public class MediaServerStreamInfo
    {
        ...
        private uint? ssrc;
        private bool? _stopRecordWithAPI = false;
        ...
        /// </summary>
        public bool? StopRecordWithAPI
        {
            get => _stopRecordWithAPI;
            set => _stopRecordWithAPI = value;
        }
    }
}