...
namespace JiebaNet.Segmenter.FinalSeg
{
    public class Viterbi : IFinalSeg
    {
        ...
        private void LoadModel()
        {
            ...
            _transProbs = System.Text.Json.JsonSerializer.Deserialize<IDictionary<char, IDictionary<char, double>>>(transJson);

            var emitJson = File.ReadAllText(Path.GetFullPath(ConfigManager.ProbEmitFile));
            _emitProbs = System.Text.Json.JsonSerializer.Deserialize<IDictionary<char, IDictionary<char, double>>>(emitJson);
