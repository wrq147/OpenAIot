<template>
	<view class="uni-data-tree" :class="{'dark_data_tree':isDark}">
		...
		<view class="uni-data-tree-dialog" v-if="isOpened">
			...
			<data-picker-view class="picker-view" ref="pickerView" v-model="dataValue" :localdata="localdata"
				...
				:map="map" :ellipsis="ellipsis" @change="onchange" @datachange="ondatachange" @nodeclick="onnodeclick" :isDark="isDark">
			</data-picker-view>
		</view>
	</view>
</template>
...
<style>
	...
	.dark_data_tree .input-value-border{
		border: 1rpx solid rgba(255, 255, 255, 0.20);
	}
	.dark_data_tree .text-color {
	...
	.dark_data_tree .uni-data-tree-dialog {
