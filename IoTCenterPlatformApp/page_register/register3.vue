<template>
	<view style="min-height: 100vh;background-color: #ffffff;">
		...
		<view class="register_con">
			...
			<view class="text_tips" style="margin-top: 154rpx;">
				<view class="">
					系统已发送验证码至手机:
				</view>
				<view class="">
			...
			<view class="code_con">
				<wolfPhoneInput ref="wolfPhoneInput" :inputType="1" :inputCount="6" :rowSpaceWidth="4"
					:inputHeight="50" :inputCircleWidth="1" :inputCircleRadius="6" :numFontSize="22"
					:inputCircleDefaultCol="'#F8F8F8'" :inputCircleSelectedCol="'#2E9DFF'"
					:inputContentCol="'#333333'" @completeInput="completeInput" />
			</view>
...
<script>
	...
	import wolfPhoneInput from '@/page_register/components/wolf-phone-input/wolf-phone-input.vue'
	export default {
		components:{wolfPhoneInput},
		data() {
			return {
				codeUrl: '',
				imgCode: '',
		...
		methods: {
			...
			completeInput(value) {
				if (value && value.length == 6) {
					...
					this.$refs.promptMsg.open('请输入一个六位数的验证码', 2000)
