...
export const constantRoutes = [{
    ...
    {
        path: '/report/datav/datavRelease',
        name: 'datavRelease',
        component: (resolve) => require(['@/views/report/datav/datavRelease'], resolve),
        hidden: true
    },
    {
        path: '/report/print/design',
        component: (resolve) => require(['@/views/report/print/design'], resolve),
        hidden: true
    },
    {
        path: '/report/datav/datavDraw',
        component: (resolve) => require(['@/views/report/datav/datavDraw'], resolve),
        hidden: true
    },
    {
        path: '/report/datav/datavView',
        component: (resolve) => require(['@/views/report/datav/datavView'], resolve),
        hidden: true
    },
    {
        path: '/report/spreadSheet',
        name: 'spreadSheet',
        component: (resolve) => require(['@/views/report/spreadSheet'], resolve),
        hidden: true
    },
    {
        path: '/report/spreadSheet/viewDataReport',
        component: (resolve) => require(['@/views/report/spreadSheet/viewDataReport'], resolve),
        hidden: true
    },
    {
        ...
        children: [{
            ...
            component: (resolve) => require(['@/views/crm/customer/customerDetail'], resolve),
            name: 'customerDetail',
            meta: { title: '客户详情', icon: 'dashboard', affix: false }
        }]
    }, {
        path: '/crm/opport',
        component: Layout,
        ...
        hidden: true,
        children: [{
            path: '/crm/opport/details',
            component: (resolve) => require(['@/views/crm/opport/details'], resolve),
            name: 'details',
            meta: { title: '商机详情', icon: 'dashboard', affix: false }
        }]
    }, {
        path: '/crm/clue',
        component: Layout,
        ...
        children: [{
            ...
            component: (resolve) => require(['@/views/crm/clue/clueDetail'], resolve),
            name: 'clueDetail',
            meta: { title: '线索详情', icon: 'dashboard', affix: false }
        }]
    }, {
