...
import CONSTANT from '@/components/print/js/constant.js'
import { mapActions, mapState } from 'vuex'
import { Context, ContextItem, directive } from '@/components/print/RoyContext'
import ComponentAdjuster from '@/components/print/Editor/ComponentAdjuster'
import { getComponentRotatedStyle, getShapeStyle } from '@/components/print/js/style-util.js'
import Big from 'big.js'
import RoyText from '@/components/print/PageComponents/RoyText'
import RoySimpleText from '@/components/print/PageComponents/RoySimpleText'
import RoyRect from '@/components/print/PageComponents/RoyRect'
import RoyLine from '@/components/print/PageComponents/RoyLine'
import RoyImage from '@/components/print/PageComponents/RoyImage'
import RoyQrcode from '@/components/print/PageComponents/RoyQrcode'
import RoyStar from '@/components/print/PageComponents/RoyStar'
import RoyCircle from '@/components/print/PageComponents/RoyCircle'
import RoySimpleTable from '@/components/print/PageComponents/RoyTable/RoySimpleTable.vue'
import RoyComplexTable from '@/components/print/PageComponents/RoyTable/RoyComplexTable'
import RoyGroup from '@/components/print/PageComponents/RoyGroup'
import Area from '@/components/print/Editor/Area'
import commonMixin from '@/mixins/print/commonMixin'
import { $, isPreventDrop } from '@/components/print/js/html-util.js'
import EditorLine from '@/components/print/Editor/EditorLine'
import EditorCoordinate from '@/components/print/Editor/EditorCoordinate'
...
export default {
  ...
  methods: {
    ...
    handleMouseDown(e) {
      ...
      // this.$store.commit('printTemplateModule/setComponentCount');
      this.hideArea()
