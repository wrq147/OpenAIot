...
<script>
import { StyledText } from '@/components/print/PageComponents/style'
import RoyModal from '@/components/print/RoyModal/RoyModal'
import WangToolbar from '@/components/print/PageComponents/WangEditorVue/WangToolbar'
import WangEditor from '@/components/print/PageComponents/WangEditorVue/WangEditor'
import { toolBarConfig, editorConfig, mode } from '@/components/print/config/editorConfig'
