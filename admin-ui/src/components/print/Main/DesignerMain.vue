...
import ToolBar from '@/components/print/ToolBar/ToolBar.vue'
import Editor from '@/components/print/Editor/Editor.vue'
import { componentList } from '@/components/print/config/componentList'
