  ...
  <div class="ai-chat-container">
    ...
    <div class="chat-message-box" ref="messageBox">
      ...
      <div v-if="ChatMessageList.length === 0" class="empty-state">
        ...
        <div class="quick-questions">
          ...
          <span class="quick-btn" @click="handleQuickSend('资讯：新一代智能体 OpenClaw 推动 AI 原生组织深度变革')">资讯：新一代智能体 OpenClaw 推动 AI
            原生组织深度变革</span>
        </div>
      </div>
    ...
    <div class="chat-input-box">
      <div class="input-wrapper">
        <el-input v-model="userInput" type="textarea" :rows="1" placeholder="请输入你的问题..."
          @keyup.enter.native="handleSend" :disabled="loading" class="chat-input" />
        <el-button type="primary" class="send-btn" @click="handleSend" :loading="loading">发送</el-button>
      </div>
      <!-- 底部工具栏 -->
      <div class="toolbar">
        <div class="toolbar-left">
          ...
          <span class="split">|</span>
          <div class="tool-btn">编程</div>
          <span class="split">|</span>
          <div class="tool-btn">帮我写作</div>
          <span class="split">|</span>
          <div class="tool-btn">视频生成</div>
          <span class="split">|</span>
