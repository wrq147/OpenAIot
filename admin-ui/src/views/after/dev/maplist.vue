  ...
  <div style="padding: 20px 20px 0 20px" id="big_con">
    ...
    <div class="elbiaoge_elform" :style="{ 'min-height': 'calc(100vh - 136px)', position: 'relative' }">
      <div class="totalinfo_ul" v-if="totalInfo">
        <div class="totalinfo_li" :class="{'active_li':NetStatus==''&&DState==''}" @click.stop="setFilterData('','')">
        ...
        <div class="totalinfo_li" :class="{'active_li':NetStatus==1&&DState==''}" @click.stop="setFilterData(1,'')">
        ...
        <div class="totalinfo_li" :class="{'active_li':NetStatus==0&&NetStatus!=''&&DState==''}" @click.stop="setFilterData(0,'')">
        ...
        <div class="totalinfo_li" :class="{'active_li':NetStatus==2&&DState==''}" @click.stop="setFilterData(2,'')">
...
beforeDestroy() {
  ...
  methods: {
    ...
    async getDevListList(){//获取设备编码列表接口
      // if(this.NetStatus!=''&&this.NetStatus!=undefined&&this.NetStatus!=null){
      //   this.DevListQueryParams.NetStatus=this.NetStatus
      // }else{
      //   delete this.DevListQueryParams.NetStatus
      // }
      // if(this.DState!=''&&this.DState!=undefined&&this.DState!=null){
      //   this.DevListQueryParams.DState=this.DState
      // }else{
      //   delete this.DevListQueryParams.DState
      // }
    ...
    loadDevMapList(mapObj,defZoom) {
      if(this.NetStatus!=''&&this.NetStatus!=undefined&&this.NetStatus!=null){
        mapObj.NetStatus=this.NetStatus
      }else{
        delete mapObj.NetStatus
      }
      if(this.DState!=''&&this.DState!=undefined&&this.DState!=null){
        mapObj.DState=this.DState
      }else{
        delete mapObj.DState
      }
