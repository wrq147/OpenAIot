...
export const baseComponents = [{
    ...
    components: [{
        ...
        },
        {
            title: '金额输入框',
            name: 'AmountInput',
            icon: 'zhongtai-icon-flow-jineshuru',
            isSvgIcon: true, //是否是自定义的sv图标
            value: '',
            valueType: ValueType.number,
            props: {
                required: false,
        ...
        },
        {
            title: '多选框',
            name: 'MultipleSelect',
            icon: 'zhongtai-icon-flow-duoxuankuang',
            isSvgIcon: true, //是否是自定义的sv图标
            value: [],
            valueType: ValueType.array,
            props: {
        ...
        },
        {
            title: '日期时间区间',
            name: 'DateTimeRange',
            icon: 'zhongtai-icon-flow-riqishijianqujian',
            isSvgIcon: true, //是否是自定义的sv图标
        ...
        },
        {
            title: '部门选择',
            name: 'DeptPicker',
            icon: 'zhongtai-icon-flow-bumenxuanze',
            isSvgIcon: true, //是否是自定义的sv图标
            value: [],
