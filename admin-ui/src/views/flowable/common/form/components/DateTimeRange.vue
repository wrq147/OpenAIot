<template>
  <div>
    ...
    <div v-else>
      <el-date-picker v-model="_value" :disabled="disabled" size="medium" clearable :value-format="format" :type="type" :start-placeholder="placeholder[0]" :end-placeholder="placeholder[1]"/>
      <div v-if="showLength" class="length">
        <span>时长：</span>
        <span>{{timeLength}}</span>
      </div>
