      ...
      <el-row :gutter="20">
        ...
        <el-col :span="24" :xs="24">
          ...
          <div class="elbiaoge_elform">
            ...
            <el-table v-loading="loading" :data="planList" border :header-cell-style="cellSty" style="width:100%">
              ...
              <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200">
                <template slot-scope="scope">
                  <el-button v-if="scope.row.Status == 0" type="text" icon="el-icon-edit"
                    @click="handleAdd(scope.row)">编辑</el-button>
                  <el-button v-else type="text" icon="el-icon-notebook-2"
                    @click="handleDetail(scope.row)">详情</el-button>
                  <el-button v-if="scope.row.Status === 0 || scope.row.Status === 5" type="text" icon="el-icon-delete"
                    style="color:red" @click="handleDelete(scope.row.Id)">删除</el-button>
                  <el-button v-if="scope.row.Status === 1" type="text" style="color:rgb(230, 162, 60)"
                    icon="el-icon-close" @click="handleCancel(scope.row.Id)">取消</el-button>
                </template>
              </el-table-column>
            </el-table>
