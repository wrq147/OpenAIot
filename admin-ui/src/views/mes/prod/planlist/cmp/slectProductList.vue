<template>
  <el-dialog v-if="deviceOpen" title="请选择所属产品" :visible.sync="deviceOpen" :close-on-click-modal="false" append-to-body
    width="980px" top="2vh" @close="cancel">
    <el-alert style="margin-bottom: 10px;" title="注意：只能选择已绑定了工艺路线的产品" type="warning" show-icon>
    </el-alert>
