      ...
      <el-row :gutter="20">
        ...
        <el-col :span="24" :xs="24">
          ...
          <div class="elbiaoge_elform" :style="{ 'min-height': tableConHeight + 'px' }">
            ...
            <el-table v-loading="loading" :data="bomList" class="data_table" :row-style="isRed"
              @selection-change="handleSelectionChange" :header-cell-style="cellSty" style="width:100%" :fit="true">
