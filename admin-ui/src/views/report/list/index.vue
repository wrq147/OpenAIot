<template>
  <div class="app-container">
    ...
    <div style="background-color: rgb(255, 255, 255);">
        ...
        <div class="content__item-list">
          <div class="content__item" v-for="item in screenList" :key="item.Id" >
            <el-card shadow="hover" :body-style="{ padding: '0px' }">
              <img v-if="item.Thumbnail !==''" :src="item.Thumbnail" class="image" style="width: 100%;height: 156px;" @click="view(item.Id)" />
              ...
              <div style="padding: 2px 10px;display: flex;justify-content: space-between;align-items: center;">
                ...
                <div style="display: flex; align-items: center;">
                  <el-switch
                    @change="releaseStatus(item, $event)"
                    v-model="item.Status"
                    active-color="#13ce66"
                  ...
                  <el-dropdown>
                    ...
                    <el-dropdown-menu slot="dropdown">
                      ...
                      <el-dropdown-item @click.native="release(item)">
                        <i :class="'el-tooltip ' + (item.Status == '2'? 'el-icon-star-on':'el-icon-star-off')" style="cursor: pointer"> 发布</i>
                      </el-dropdown-item>
                    </el-dropdown-menu>
                  </el-dropdown>
                </div>
      ...
      <pagination v-show="total>0" :total="total" :page.sync="queryParams.pageNum" :limit.sync="queryParams.pageSize" @pagination="getList" :pageSizes="[12,24,36,48,60]"/>
    </div>
    <!-- 数据大屏保存参数配置对话框 -->
