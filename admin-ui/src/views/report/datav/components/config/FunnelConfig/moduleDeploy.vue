<template>
    <el-form size="small" label-width="90px">
      <el-collapse v-model="activeNames" accordion>
        ...
        <el-collapse-item title="排序方式" name="4">
          <el-form-item v-if="configData.chartOption.sort!==undefined" label="排序方式">
            <el-select v-model="configData.chartOption.sort" placeholder="请选择">
              <el-option label="从大到小" value="descending"></el-option>
              <el-option label="从小到大" value="ascending"></el-option>
              <el-option label="小大小" value="desAsc"></el-option>
              <el-option label="大小大" value="ascDes"></el-option>
