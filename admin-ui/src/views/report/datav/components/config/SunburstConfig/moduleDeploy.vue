    ...
    <el-form size="small" label-width="90px">
      <el-collapse v-model="activeNames" accordion>
        ...
        <el-collapse-item title="图形设置" name="3">
          <el-form-item v-if="configData.chartOption.radius!==undefined" label="半径大小">
            <el-slider v-model="configData.chartOption.radius[0]" :min="1" :step="1" show-input></el-slider>
          </el-form-item>
          <el-form-item v-if="configData.chartOption.itemStyle.borderWidth!==undefined" label="边框宽度">
            <el-slider v-model="configData.chartOption.itemStyle.borderWidth" :min="1" :step="1" show-input></el-slider>
          </el-form-item>
          <el-form-item v-if="configData.chartOption.sort!==undefined" label="排序方式">
            <el-select v-model="configData.chartOption.sort" placeholder="请选择">
              <el-option label="不排序" value="null"></el-option>
        ...
        <el-collapse-item title="标签设置" name="4">
          <el-form-item  label="显示标签">
            <el-switch v-model="configData.chartOption.label.show"></el-switch>
          </el-form-item>
          <el-form-item v-if="configData.chartOption.label.rotate!==undefined" label="旋转角度">
            <el-radio-group v-model="configData.chartOption.label.rotate">
              <el-radio label="radial" >径向旋转</el-radio>
              <el-radio label="tangential">切向旋转</el-radio>
            </el-radio-group>
          </el-form-item>
