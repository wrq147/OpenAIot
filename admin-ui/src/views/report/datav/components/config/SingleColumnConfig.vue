        ...
        <el-form v-if="currentTab==='field'" size="small" label-width="90px">
          <el-collapse  v-model="activeNames" accordion>
            ...
            <el-collapse-item title="标题" name="2">
              ...
              <el-form-item v-if="configData.chartOption.tooltipName!==undefined" label="提示名称">
                <el-input v-model="configData.chartOption.tooltipName" placeholder="请输入副标题" />
              </el-form-item>
            ...
            <el-collapse-item title="文字" name="4">
              ...
              <el-form-item v-if="configData.chartOption.rich.name.fontSize!==undefined" label="数据名称字体大小">
                  <el-slider v-model="configData.chartOption.rich.name.fontSize" :min="1" :max="200" :step="1" show-input></el-slider>
              </el-form-item>

              <el-form-item v-if="configData.chartOption.rich.name.color!==undefined" label="数据名称字体颜色">
                <el-color-picker v-model="configData.chartOption.rich.name.color" show-alpha></el-color-picker>
              </el-form-item>

              <el-form-item v-if="configData.chartOption.rich.value.fontSize!==undefined" label="数值字体大小">
                  <el-slider v-model="configData.chartOption.rich.value.fontSize" :min="1" :max="200" :step="1" show-input></el-slider>
              </el-form-item>

              <el-form-item v-if="configData.chartOption.rich.value.color!==undefined" label="数值字体颜色">
                <el-color-picker v-model="configData.chartOption.rich.value.color" show-alpha></el-color-picker>
              </el-form-item>
        ...
        <el-form v-if="currentTab === 'interaction'" size="small" label-width="90px">
          ...
          <el-form-item  v-show="configData.chartOption.isLink===true" label="*参数说明">
            <div class="el-form-item__content">
              <span style="word-wrap: break-word;"><i style="color:#F00;">参数名={"seriesName":"xxx","data":xxx}</i></span>
            </div>
            <div class="el-form-item__content">
          ...
          <el-form-item  v-show="configData.chartOption.isRemote === true" label="*参数说明">
            <div class="el-form-item__content">
              <span style="word-wrap: break-word;"><i style="color:#F00;">{"seriesName":"xxx","data":xxx}</i></span>
            </div>
            <div class="el-form-item__content">
              <span style="display:block;">seriesName:系列名称</span>
              <span >data:选中值</span>
