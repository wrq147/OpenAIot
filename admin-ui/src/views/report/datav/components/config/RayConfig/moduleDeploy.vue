    ...
    <el-form size="small" label-width="90px">
      <el-collapse v-model="activeNames" accordion>
        <el-collapse-item title="图层" name="1">
          ...
          <el-form-item v-if="configData.chartOption.color1!==undefined" label="颜色">
          ...
          <el-form-item v-if="configData.chartOption.dur!==undefined" label="动画时长">
            <el-slider v-model="configData.chartOption.dur" :min="0" :max="20" :step="0.5" show-input></el-slider>
          </el-form-item>

          <el-form-item v-if="configData.chartOption.reverse!==undefined" label="是否纵向">
