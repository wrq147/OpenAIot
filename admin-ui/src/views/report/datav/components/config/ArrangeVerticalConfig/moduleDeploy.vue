        ...
        <el-collapse  v-model="activeNames" accordion>
          ...
          <el-collapse-item title="容器样式" name="2" class="nopaddingbottom" v-if="configData.chartOption.cotStyle">
            ...
            <el-form-item label="容器背景图片" v-if="!isShowBgAct&&configData.chartOption.cotStyle.bgType=='img'">
              <image-upload fontPlus="20px" width="100px" height="100px" lineHeight="100px" v-model="configData.chartOption.cotStyle.containerBgImage" :limit="1"></image-upload>
            </el-form-item>
            ...
            <el-form-item v-if="isShowBgAct&&configData.chartOption.cotStyle.containerBg!==undefined">
              ...
              <div v-for="(tmpitem, index) in configData.chartOption.cotStyle.containerBg" :key="'a' + index" style="margin-bottom: 10px;display:flex;align-items:center;">
                <el-input style="width:110px;margin-right:10px;" v-model="configData.chartOption.cotStyle.containerBg[index].value" placeholder="请输入对应数值"/>
