    ...
    changeGlobalProcessor(val, isType) {
      ...
      if (isType) {
        if (this.filedSelected && this.filedSelected.length > 0) {
          this.$set(this.configData.chartOption,"tableSelectLine",this.filedSelected);
          this.$nextTick(() => {
            if (
    ...
    handleSelectionChange(val) {
      ...
      if (this.filedSelected.length > 0) {
        // if (this.ishandleSelect) {
          let str = this.filterResultData[0][this.filedSelected[0].filed];
          this.$set(
            this.configData.chartOption,
            "tableSelectLine",
            this.filedSelected
