    ...
    <el-collapse v-model="activeNames" accordion>
      ...
      <el-collapse-item title="表格行样式设置" name="22">
        <draggable :animation="340" group="selectItem" handle=".option-drag">
          ...
          <template v-if="configData.chartOption.tableColumsStyle&&configData.chartOption.tableColumsStyle.length>0">
      ...
      <el-collapse-item title="表格样式" name="4">
        <el-form-item label="显示排名">
          <el-switch v-model="configData.chartOption.showRank" />
        </el-form-item>
