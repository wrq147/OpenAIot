    ...
    <el-collapse v-model="activeNames" accordion>
      ...
      <el-collapse-item title="滚动设置" name="5">
        ...
        <el-form-item v-if="configData.chartOption.velocity !== undefined" label="滚动速度">
          <el-slider v-model="configData.chartOption.velocity" :min="0" :max="5" :step="0.1" show-input />
        </el-form-item>
        ...
        <el-form-item v-if="configData.chartOption.singleHeight !== undefined" label="单行停顿">
          <el-slider v-model="configData.chartOption.singleHeight" :min="0" :max="500" :step="1" show-input />
        </el-form-item>

        <el-form-item v-if="configData.chartOption.waitTime !== undefined" label="停顿时间">
          <el-input-number class="inputFontSize" v-model="configData.chartOption.waitTime" controls-position="right" :step="500" />
        </el-form-item>
      </el-collapse-item>
