    ...
    <el-form size="small" label-width="90px">
      <el-collapse v-model="activeNames" accordion>
        ...
        <el-collapse-item title="阴影" name="4">
          <el-form-item v-if="configData.chartOption.isArea!==undefined" label="显示阴影">
            <el-switch v-model="configData.chartOption.isArea" />
          </el-form-item>
        </el-collapse-item>
        <el-collapse-item title="形状" name="5">
          <el-form-item v-if="configData.chartOption.shape!==undefined" label="形状">
            <el-radio v-model="configData.chartOption.shape" label="">多边形</el-radio>
            <el-radio v-model="configData.chartOption.shape" label="circle">圆形</el-radio>
          </el-form-item>
        </el-collapse-item>
        <el-collapse-item title="文字" name="6">
          <el-form-item v-if="configData.chartOption.fontColor!==undefined" label="文字颜色">
            <el-color-picker v-model="configData.chartOption.fontColor" show-alpha></el-color-picker>
          </el-form-item>
          <el-form-item v-if="configData.chartOption.backgroundColor!==undefined" label="文字背景颜色">
