    ...
    <div class="field-box" v-if="currentTab === 'data'">
      <el-scrollbar class="right-scrollbar">
        ...
        >
          ...
          >
            <!-- 静态样式 -->
            <staticslot :configData="configData"></staticslot>
          </template>
...
export default {
  ...
  data() {
    return {
      ...
      filterResultData: [],
      defauleValue: [
        { content: "北京", bindid: 273 },
        { content: "上海", bindid: 265 },
        { content: "深圳", bindid: 200 },
        { content: "重庆", bindid: 150 },
        { content: "天津", bindid: 300 },
        { content: "哈尔滨", bindid: 205 },
      ],
      defaultKeyList: [
        {
          key: "bindid",
