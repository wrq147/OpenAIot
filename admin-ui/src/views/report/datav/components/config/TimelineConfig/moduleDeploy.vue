        ...
        <el-collapse v-model="activeNames" accordion>
          ...
          <el-collapse-item title="默认样式" name="2">
            ...
            <el-form-item v-if="configData.chartOption.symbolSize !== undefined" label="圆点大小">
              <el-slider v-model="configData.chartOption.symbolSize" :min="1" :max="50" :step="1"
          ...
          <el-collapse-item title="选中样式" name="3">
            ...
            <el-form-item v-if="configData.chartOption.borderWidth !== undefined" label="边框大小">
              <el-slider v-model="configData.chartOption.borderWidth" :min="1" :max="50" :step="1"
                show-input></el-slider>
            </el-form-item>
          ...
          <el-collapse-item title="控制" name="4">
            ...
            <el-form-item label="播放间隔">
              <el-input-number v-model="configData.chartOption.playInterval" controls-position="right"
          ...
          <el-collapse-item title="绑定组件" name="5">
            ...
            <el-form-item label="绑定组件">
              <el-select v-model="configData.chartOption.bindList" multiple filterable placeholder="请选择"
                @change="bindCharts">
