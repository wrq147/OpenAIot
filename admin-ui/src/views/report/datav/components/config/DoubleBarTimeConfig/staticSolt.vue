<template>
    <div>
       ...
       <el-table border :data="configData.chartOption.staticDataValue" max-height="800" style="margin-top: 10px;"> 
           ...
           <el-table-column label="value1" align="center" :show-overflow-tooltip="true">
               <template slot-scope="scope">
                   <el-input v-model="scope.row.value1" placeholder="请输入" />
               </template>
           </el-table-column>
           <el-table-column label="value2" align="center" :show-overflow-tooltip="true">
               <template slot-scope="scope">
                   <el-input v-model="scope.row.value2" placeholder="请输入" />
               </template>
           </el-table-column>
