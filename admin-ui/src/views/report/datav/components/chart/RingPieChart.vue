    ...
    setChartVal(result) {
      ...
      let seriesOption = [
        {
          ...
          type: "pie",
          clockWise: false,
          radius: [dataOption.innerRadius, dataOption.outerRadius],
      ...
      let option = {
        ...
        title: {
          ...
          left: "49%",
          textStyle: {
            color: dataOption.fontColor ? dataOption.fontColor : "#00ffff",
            fontSize: dataOption.fontSize ? dataOption.fontSize : 22,
            fontWeight: "400"
          },
          ...
          elements: [
            {
              ...
              style: {
                image: img,
                width: dataOption.innerPieWidth,
                height: dataOption.innerPieWidth
              },
              left: "center",
              top: "center",
              position: [100, 100]
