<template>
  <div :class="className" :style="{ height: height, width: width }" :id="chartOption.bindingDiv">
    <dv-decoration-12 :key="key" :scanDur="dataOption.scanDur" :haloDur="dataOption.haloDur" :color="color" :style="{ height: height, width: width, opacity:opacity}" ref="scanDiv"/>
  </div>
</template>
