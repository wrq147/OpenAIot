...
const exportExcel = function(luckysheet, value) {
  ...
  // console.log('luckysheet', luckysheet.getAllSheets())
  luckysheet.forEach(function(table) {
    ...
    setColumnlen(columnlenInfo, worksheet)
     // 处理图片
    // console.log('table.images', table)
    setImages(table, worksheet, workbook);
    return true
  })
  // console.log('getColumnWidth', luckysheet.getColumnWidth([0,1,2]))
  // return
  // 4.写入 buffer
...
var setColumnlen = function(columnlenInfo, worksheet) {
  // console.log('columnlenInfo', columnlenInfo)
  const columnlenArr = Object.values(columnlenInfo)
  columnlenArr.forEach(function(elem,key) {
    // console.log('elem', elem,key, worksheet.columns[key])
    ...
    // 通过 base64  将图像添加到工作簿
        ...
        if (item.type == "2") {
          ...
          if(item.hasOwnProperty('fromCol')&&item.hasOwnProperty('fromRow')){
            ...
            // console.log("col_st",col_st,"row_st",row_st);
          }          
        }
