          ...
          <div>
            <el-col :span="1.5">
              <el-button
                ...
                icon="el-icon-plus"
                @click="handleAdd"
                v-hasPermi="['/AuthService/Post/Add']"
              >新增</el-button>
            </el-col>
            <el-col :span="1.5">
              <el-button
                ...
                :disabled="single"
                @click="handleUpdate"
                v-hasPermi="['/AuthService/Post/Edit']"
              >修改</el-button>
            </el-col>
            ...
            <el-col :span="1.5">
              <el-button
                ...
                @click="handleExport"
                v-hasPermi="['/AuthService/Post/Export']"
              >导出</el-button>
              <el-col :span="1.5">
                <el-button
                  type="danger"
                  ...
                  :disabled="multiple"
                  @click="handleDelete"
                  v-hasPermi="['/AuthService/Post/Remove']"
                >删除</el-button>
              </el-col>
            </el-col>
          </div>
...
export default {
  ...
  methods: {
    ...
    isRed({ row }) {
      ...
      if (checkIdList.includes(row.postId)) {
        return {
