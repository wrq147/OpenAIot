<template>
    <div class="returnpage">
        <el-dialog title="入库单" :close-on-click-modal="false" :visible.sync="open" v-loading="allloading" width="1380px"
            top="2vh">
                ...
                <div style="flex:1;width: 0;">
                    <el-descriptions title="基本信息" :column="3" border>
                        ...
                        <el-descriptions-item label="状态">
                            ...
                            <el-link style="margin-left:15px;" @click="onLook" v-if="form.Status == 4 && aboutid != null"
                                type="primary">查看退货单</el-link>
                        </el-descriptions-item>
                        ...
                        <el-descriptions-item label="物流信息" span="3">
                            <template v-if="this.form.ExpressNumber != ''">
                                <a type="primary" :href="'https://www.kuaidi100.com/?nu=' + this.form.ExpressNumber"
                                    target="_blank">
                    ...
                    <el-table :data="form.List" style="width: 100%" :header-cell-style="{'color':'#78829D','background': '#F9FAFC'}" border stripe>
        ...
        async openDialog(id) {
            ...
            try{
                ...
                if (this.form.Status == 4) {
                    let lbs=(await getLeaveBySource(this.form.Id));
                    if(lbs.code==0){
                        let rkdd = lbs.data;
                        if (rkdd != null) {
                        ...
                        this.$message.error(lbs.message);
                    }
                }
            }
            catch(ex){
