<template>
	<view class="loc-choose" v-if="showPop">
		...
		<view class="map-box">
			<view class="marker">
				<view class="loc-icon">
					<uni-icons type="location-filled" color="#D81E06" size="30"></uni-icons>
				</view>
			</view>
...
*/
	// #ifdef H5
	import $ from '@/pages_device/jquery.min.js'
	// #endif
	import {
		setPagesParam
	} from '@/common/utillib.js'
	// import {initMap} from '@/common/TMap.js'
	// #ifdef H5
	...
	export default {
		...
		data() {
			return {
				// value:true,
				mapkey: 'CAUBZ-PUFCO-7V4WO-SD2KN-4KYL2-CMB6H',
				exact: true,
				keyword: '',
				showPop: true,
				showCancel: false,
		...
		methods: {
			...
			initMap({
				...
				const center = id ? new TMap.LatLng(location.lat, location.lng) : new TMap.LatLng(lat, lng)
				//初始化地图
			...
			confirm() {
				...
				// console.log("选择的地址",this.selectAdress);
				setPagesParam('confirm', this.selectAdress, 1)
			}
		},
		filters: {}
	}
