...
import ResizeObserver from '@/components/print/PageComponents/RoyTable/ResizeObserver'
import TableDataSetting from '@/components/print/PageComponents/RoyTable/TableDataSetting'
import { StyledComplexTable } from '@/components/print/PageComponents/style'
