  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <template v-if="device !== 'mobile'">
        <!-- <search id="header-search" class="right-menu-item" style="padding-right:2px;padding-left:0;"/> -->
        <!-- <screenfull id="screenfull" class="right-menu-item hover-effect" /> -->
        <!-- <el-tooltip content="布局大小" effect="dark" placement="bottom">
          <size-select id="size-select" class="right-menu-item hover-effect" />
        </el-tooltip> -->
      </template>
      <!-- <el-dropdown v-if="checkPermission(['/MsgSrv/Message/List'])" class="right-menu-item hover-effect" trigger="click">
        <div>
          <i class="zhongtaiiconfont zhongtai-icon-xiaoxi" style="color:#7D8598" ></i>
        ...
        <el-dropdown-menu slot="dropdown" class="message_ul">
          ...
          <el-dropdown-item class="message_li last_li">
            <div @click="toMessageList" class="otherColor" style="width: 100%; height: 100%; text-align: center">前往信息中心</div>
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown> -->

      <el-dropdown class="avatar-container right-menu-item" trigger="click" style="padding-right:0">
        <div class="avatar-wrapper">
          <el-avatar shape="circle" :size="32" fit="cover" :src="avatar" v-if="avatar&&avatar.indexOf('profile')>-1"></el-avatar>
          <el-avatar shape="circle" :size="32" fit="cover" :src="avatar" v-else-if="avatar"></el-avatar>
          <el-avatar shape="circle" :size="32" fit="cover" :src="require('@/assets/images/empty_head.png')" v-else></el-avatar>
          <!-- <i class="xiajiantou" /> -->
          <span class="user_name">{{userName}}</span>
          <svg-icon icon-class="xiajiantou" class="avatar-xiajiantou" style="color:#BBC0CD"/>
        </div>
        <el-dropdown-menu slot="dropdown" style="top: 36px !important;background:rgba(34, 46, 64, 1);padding:16px 14px;box-shadow: 0px 10px 20px 0px rgba(0,0,0,0.4);border:none;">
          <el-dropdown-item class="cmp-blk" style="color:rgba(255, 255, 255, 1)">
            <div class="cmp-title">
              <i class="zhongtaiiconfont zhongtai-icon-qiyeqiehuan" style="color:rgba(255, 255, 255, 1);font-size:12px;margin-right:8px;" ></i>
              <span>企业切换</span>
            </div>
            <div class="cmp-item" v-for="orgitem in orgList" :key="orgitem.Id" @click="onSwitchOrg(orgitem.Id)" :class="{'active-item':curOrgId == orgitem.Id}">
              <!-- <span style="">　　</span> -->
          ...
          <router-link to="/user/profile" style="border-top:1px solid rgba(255, 255, 255, 0.1);padding-top:24px;margin-top:12px;">
            <el-dropdown-item style="color:rgba(255, 255, 255, 1)">
              <div class="cp-li">
                <i class="zhongtaiiconfont zhongtai-icon-gerenshezhi ic" style=""></i>
                <span>个人设置</span>
              </div>
            </el-dropdown-item>
          </router-link>
          ...
          <el-dropdown-item class="cp-li" @click.native="logout" style="color:rgba(255, 255, 255, 1);margin-top:24px">
            <i class="zhongtaiiconfont zhongtai-icon-tuichudenglu ic"></i>
            <span>退出登录</span>
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
...
.cmp-blk {
  ...
  .cmp-item:hover {
    ...
    color: rgba(61, 185, 143, 1) !important;
  }
  .cmp-item {
    // padding: 0 17px;
    display: flex;
