...
import { energyPageDateList, exportEquipmentList } from '@/api/energy/energyMeter';
...
export default {
    ...
    methods: {
        ...
        getList(currentKey, isEquipment) {
            this.loading = true;
            this.currentKey = (currentKey !== undefined && currentKey !== null && currentKey !== '' && typeof currentKey === 'string')  ? currentKey  : this.currentKey;
            this.isEquipment = isEquipment ? isEquipment : this.isEquipment;
            if (isEquipment) {
                this.queryParams.equipmentId = this.currentKey;
                this.queryParams.facilityId = '';
            } else {
                this.queryParams.facilityId = this.currentKey;
            ...
            energyPageDateList(this.queryParams).then(res => {
                this.loading = false;
        ...
        handleQuery() {
            ...
            this.getList(this.currentKey, this.isEquipment);
        },
...
/* 修复tooltip箭头颜色（与背景匹配） */
body .el-tooltip__popper.is-dark .popper__arrow::after {
