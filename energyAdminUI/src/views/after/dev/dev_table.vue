<template>
  <div>
    ...
    <el-table v-loading="configLoading" border :data="tableData" :row-style="isRed" :cell-style="isRed" @selection-change="handleSelectionChange" class="data_table"
      ...
      <el-table-column label="设备状态" align="center" key="Online" prop="Online" :show-overflow-tooltip="true">
        <template slot-scope="scope">
            <span>{{ returnDevState(scope.row) }}</span>
        </template>
      </el-table-column>
