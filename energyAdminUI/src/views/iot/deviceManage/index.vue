          ...
          <div class="from_con" id="from_con" v-show="showSearch" style="margin-bottom:0;padding-bottom:0">
            <el-form :model="deviceForm" ref="deviceForm" :inline="true" class="biaodan"
              ...
              <el-form-item label="运行状态" prop="DState" v-if="isShowDStateSerch">
                <el-select v-model="deviceForm.DState" :clearable="true" placeholder="运行状态">
              ...
              <el-form-item label="">
                <el-button class="label_filter_btn" @click="openLabelFilter">
                  <i class="zhongtaiiconfont zhongtai-icon-shaixuan" style="font-size:14px;color:#ffffff"></i>
                  <span style="margin-left:5px;color:#ffffff;">标签筛选</span>
            ...
            <el-table v-if="isShape && activeDevice == 'deviceManage'" v-loading="configLoading" class="data_table" :header-cell-style="cellSty" border :data="tableData" style="width:100%">
              ...
              <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="150">
                <template slot-scope="scope">
                  <el-button type="text" icon="el-icon-view" @click="toDeviceDetails(scope.row)">详情</el-button>
                </template>
              </el-table-column>
            </el-table>
...
export default {
  ...
  components: { Treeselect,deviceAddDialog,labelFilter },
  dicts: ["device_run"],
  data() {
    return {
      // 设备导入参数
