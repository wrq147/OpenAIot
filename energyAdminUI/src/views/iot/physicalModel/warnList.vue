<template>
  <div :style="{padding:(!isComponent?'10px 10px 0 10px':'0')}" id="big_con">
    <div>
      <el-row :gutter="20">
        <!--产品数据-->
        <el-col :span="24" :xs="24">
          ...
          >
            <el-row
              ...
              :style="{'justify-content':(filProductId?'flex-end':'space-between')}"
            >
              <div v-if="!filProductId">
                <el-col :span="1.5">
...
import { updateList, manualUpdate } from "@/api/rules/device";
export default {
  name: "WarnList",
