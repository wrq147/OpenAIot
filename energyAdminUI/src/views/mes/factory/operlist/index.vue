                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="24" :xs="24">
                        ...
                        <el-row :gutter="10" class="mb8 button_row">
                            <div>
                            <el-col :span="1.5">
                                <el-button type="primary" icon="el-icon-plus" plain @click="handleAdd('')">新增生产工序</el-button>
                            </el-col>
                            </div>
                        </el-row>
  ...
  export default {
    ...
    mounted() {
        this.activeFiledList = [
            { "field": "Id", "fieldName": "工序编号", "type": "文本", "isShow": true, "isFixed": false },
            { "field": "OperName", "fieldName": "工序名称", "type": "文本", "isShow": true, "isFixed": false },
            { "field": "PropOf", "fieldName": "报工数配比", "type": "文本", "isShow": true, "isFixed": false },
            { "field": "WorkTime", "fieldName": "预计工时(分钟)", "type": "文本", "isShow": true, "isFixed": false },
            { "field": "PriceMethod", "fieldName": "计件、计时", "type": "文本", "isShow": true, "isFixed": false },
            { "field": "UnitPrice", "fieldName": "工资单价", "type": "文本", "isShow": true, "isFixed": false },
            { "field": "Update_time", "fieldName": "更新时间", "type": "时间", "isShow": true, "isFixed": false },
        ];
        this.getList();
    ...
    methods: {
        ...
        handleAdd(data) {
            if (data === '') {
                ...
                this.$refs['addOper'].employees = data.AssignedUser === '' ? [] : JSON.parse(data.AssignedUser);
                this.$refs['addOper'].loadDeviceList(data.DeviceIds);
                this.$refs['addOper'].fieldsInit = data.FieldsInit === ''? [{ sid: '', tid: '' }] : JSON.parse(data.FieldsInit);
