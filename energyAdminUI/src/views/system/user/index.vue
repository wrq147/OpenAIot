<template>
        ...
        <el-col :span="24" :xs="24">
          <div class="from_con" id="from_con" v-show="showSearch">
            <el-form class="biaodan" :model="queryParams" ref="queryForm" :inline="true">
              <el-form-item label="搜索关键词" prop="key">
                <el-input class="set_radius" v-model="queryParams.key" placeholder="请输入要搜索的用户名、手机、昵称或企业名" clearable @keyup.enter.native="handleQuery"/>
              </el-form-item>
          ...
          <div class="elbiaoge_elform" :style="{'min-height':tableConHeight+'px'}">
            <el-row :gutter="10" class="mb8 button_row">
              <div>
                <el-col :span="1.5">
                  <el-button type="primary" plain @click="handleAdd" v-hasPermi="['/AuthService/User/Add']">
                  <i class="zhongtaiiconfont zhongtai-icon-xinzeng"></i>
                    <span style="margin-left:6px">新增</span>
                  </el-button>
                </el-col>
                <el-col :span="1.5">
                  <el-button type="success" plain :disabled="single" @click="handleUpdate" v-hasPermi="['/AuthService/User/Edit']">
                  <i class="zhongtaiiconfont zhongtai-icon-xiugai"></i>
                    <span style="margin-left:6px">修改</span>
                  </el-button>
                </el-col>
                <el-col :span="1.5">
                  <el-button type="danger" plain :disabled="single" @click="handleDelete" v-hasPermi="['/AuthService/User/Remove']">
                  <i class="zhongtaiiconfont zhongtai-icon-shanchu"></i>
                    <span style="margin-left:6px">删除</span>
                  </el-button>
                </el-col>
                <el-col :span="1.5">
                  <el-button type="info" plain @click="handleImport" v-hasPermi="['/AuthService/User/Import']">
                  <i class="zhongtaiiconfont zhongtai-icon-daoru"></i>
                    <span style="margin-left:6px">导入</span>
                  </el-button>
                </el-col>
                <el-col :span="1.5">
                  <el-button type="warning" plain :loading="exportLoading" @click="handleExport" v-hasPermi="['/AuthService/User/Export']">
            ...
            <el-table v-loading="loading" :data="userList" :row-style="isRed" :cell-style="isRed" @selection-change="handleSelectionChange" class="data_table" :header-cell-style="cellSty" style="width:100%">
              <el-table-column type="selection" width="50" align="center" />
              <el-table-column label="用户编号" align="center" key="Id" prop="Id" v-if="columns[0].visible" width="200"/>
              <el-table-column label="用户名称" align="center" key="UserName" prop="UserName" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
              <el-table-column label="用户昵称" align="center" key="RealName" prop="RealName" v-if="columns[2].visible" :show-overflow-tooltip="true"/>
              <el-table-column label="所在企业" align="center" key="OrgNames" prop="OrgNames" width="250" v-if="columns[3].visible" :show-overflow-tooltip="true"/>
              <el-table-column label="手机号码" align="center" key="Mobile" prop="Mobile" v-if="columns[4].visible" width="150"/>
 ...
 <!-- 角色分配对话框 -->
  <el-dialog title="分配角色" :close-on-click-modal="false" :visible.sync="roleDialogOpen" width="900px" append-to-body>
    <div style="padding: 15px;">
      <!-- 已分配角色表格 -->
      <el-table :data="assignedRoles" border stripe style="width: 100%; margin-bottom: 15px">
        <el-table-column prop="RoleName" label="角色名称"></el-table-column>
        <el-table-column prop="OrgName" label="所属企业"></el-table-column>
        <el-table-column prop="RoleDesc" label="角色描述"></el-table-column>
        <el-table-column label="操作" width="100" align="center">
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="removeRole(scope.row)" v-if="scope.row.IsSystem=='1'">
      ...
      <el-form :inline="true" :model="formInline">
        <el-form-item label="系统角色" required>
          <el-select v-model="formInline.roleId" placeholder="请选择">
            <el-option v-for="item in systemRoles" :key="item.roleId" :label="item.roleName" :value="item.roleId"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="所属企业">
          <el-select v-model="formInline.orgId" placeholder="请选择">
            <el-option v-for="item in userOrgs" :key="item.Id" :label="item.OrgName" :value="item.Id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
