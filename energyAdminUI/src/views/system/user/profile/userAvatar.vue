<template>
  <div>
    <div class="user-info-head" @click="editCropper()"><img :src="options.img" title="点击上传头像" class="img-circle img-lg" style="line-height: 100px;"/></div>
...
export default {
  ...
  mounted(){
    // console.log("store.getters.avatar",this.$store.getters.avatar);
    ...
    uploadImg() {
      this.$refs.cropper.getCropBlob(data => {
        ...
        uploadAvatar(formData).then(response => {
          // console.log("上传头像response",response);
          this.open = false;
