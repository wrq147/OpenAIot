      ...
      <div class="from_con" id="from_con">
        ...
        >
          <el-form-item label="模板名称" prop="Name">
            <el-input style="width:140px" v-model="queryParams.Name" placeholder="请输入模板名称" clearable
            />
          </el-form-item>
      ...
      <div class="elbiaoge_elform" :style="{'min-height':tableConHeight+'px'}">
        <el-row :gutter="10" class="mb8 button_row">
          <div>
            ...
            <el-col :span="1.5">
              <el-button :disabled="single" type="success" plain @click="handleUpdate(selection[0])">
        ...
        <el-table @selection-change="handleSelectionChange" border v-loading="loading" :data="tbList" class="data_table" :header-cell-style="cellSty">
          ...
          <!-- <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="258">
            <template slot-scope="scope">
              <el-button type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)" v-hasPermi="['/ReportService/Print/Edit']">修改</el-button>
              <el-button type="text" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['/ReportService/Print/Remove']">删除</el-button>
            </template>
          </el-table-column> -->
        </el-table>
