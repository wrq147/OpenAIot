    ...
    public class ComputerUtil
    {
        ...
        public static string GetRunTime()
        {
            ...
            if (IsUnix())
            {
                ...
                runTime = MyAccess.Core.StringTool.DateToRelative(DateTime.ParseExact(output, "yyyyMMddHHmmss", System.Globalization.CultureInfo.CurrentCulture), DateTime.Now);
            }
            else
            {
                ...
                if (outputArr.Length == 2)
                    runTime = MyAccess.Core.StringTool.DateToRelative(DateTime.ParseExact(outputArr[1].Split('.')[0], "yyyyMMddHHmmss", System.Globalization.CultureInfo.CurrentCulture), DateTime.Now);
            }
            return runTime;
        }
