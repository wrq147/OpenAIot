...
namespace ProducerService
{
    ...
    public class ProducerMigrator : Migration
    {
        ...
        {
            if (Schema.Table("mz_factory").Exists())
            {
                Execute.Sql("DROP TABLE IF EXISTS mz_agent_flow");
    ...
    .WithColumn("OverTime").AsDateTime().WithColumnDescription("过期时间")
          ...
          .WithColumn("update_time").AsDateTime().WithColumnDescription("更新时间");
                ...
                Create.Table("mz_product").WithDescription("产品表")
                               ...
                               .WithColumn("StrExt1").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt2").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt3").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt4").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt5").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt6").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt7").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt8").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt9").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt10").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt11").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt12").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt13").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt14").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt15").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt16").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt17").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt18").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt19").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt20").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt21").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt22").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt23").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt24").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt25").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt26").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt27").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt28").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt29").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt30").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt31").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt32").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt33").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt34").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt35").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt36").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt37").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt38").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt39").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt40").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt41").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt42").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt43").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt44").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt45").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt46").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt47").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt48").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt49").AsString(500).Indexed().Nullable()
                                .WithColumn("StrExt50").AsString(500).Indexed().Nullable()
                                .WithColumn("NumExt1").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt2").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt3").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt4").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt5").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt6").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt7").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt8").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt9").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt10").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt11").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt12").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt13").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt14").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt15").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt16").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt17").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt18").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt19").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt20").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt21").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt22").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt23").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt24").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt25").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt26").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt27").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt28").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt29").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt30").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt31").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt32").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt33").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt34").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt35").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt36").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt37").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt38").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt39").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt40").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt41").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt42").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt43").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt44").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt45").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt46").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt47").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt48").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt49").AsDouble().Indexed().Nullable()
                                .WithColumn("NumExt50").AsDouble().Indexed().Nullable()
                               .WithColumn("createId").AsInt64().WithColumnDescription("创建者Id")
                               .WithColumn("create_time").AsDateTime().WithColumnDescription("创建时间")
                               .WithColumn("updateId").AsInt64().WithColumnDescription("更新者Id")
                               .WithColumn("update_time").AsDateTime().WithColumnDescription("更新时间");
