    ...
    public class SmsMigrator : Migration
    {
        public override void Up()
        {
            ...
            Insert.IntoTable("mz_config").Row(new
            {
                ...
                config_key = "sms.json",
                config_value = "{\"sms_template\": {\r\n      \"验证码\": {\"action\":\"send\",\"account\":\"OpenAIot\",\"password\":\"kkkk\",\"mobile\":\"$mobile\",\"content\":\"【OpenAIot】验证码：$code，2分钟内有效\",\"extno\":\"10690\"},\r\n      \"邀请短信\": {\"action\":\"send\",\"account\":\"123539\",\"password\":\"4aukzLnizDVhlP\",\"mobile\":\"$mobile\",\"content\":\"【OpenAIot】OpenAIot平台邀请您加入我们，点击链接即可登录$url\",\"extno\":\"10690\"},\r\n      \"设备告警\": {\"action\":\"send\",\"account\":\"123539\",\"password\":\"4aukzLnizDVhlP\",\"mobile\":\"$mobile\",\"content\":\"【OpenAIot】$label，$content，请尽快确认并修复。\",\"extno\":\"10690\"}\r\n    },\r\n    \"url\": \"http://47.99.242.143:7862/smsv2\",\r\n    \"ok\": \"\\\"status\\\":0,\"}",
                config_type = "Y",
            ...
            Insert.IntoTable("mz_config").Row(new
            {
                ...
                config_value = "{\r\n    \"account\": \"aaa\",\r\n    \"secret\": \"bbb\",\r\n    \"sms_template\": {\r\n        \"验证码\": \"验证码：$code，2分钟内有效\",\r\n        \"邀请短信\": \"OpenAIot平台邀请您加入我们，点击链接即可登录$url\",\r\n        \"设备告警\": \"$label，$content，请尽快确认并修复。\"\r\n    },\r\n    \"signatureStr\": \"OpenAIot\"\r\n}",
                config_type = "Y",
